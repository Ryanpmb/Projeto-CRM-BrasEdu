...
public class CustomerController {
    ...
    @PostMapping
    public ResponseEntity<CustomerEntity> createCustomer(@RequestBody CreateCustomerDto newCustomerDto) {
        try {
    ...
    public ResponseEntity<CustomerEntity> updateCustomer(
            @RequestBody CustomerEntity newCustomerInformations,
    ...
    public ResponseEntity<Iterable<CustomerEntity>> getAllCustomers() {
        Iterable<CustomerEntity> customers = customerService.findAll();
